@include('admin.layouts.header')
    ...
    <div class="sidebar-left sidebar-fixed ps-container ps-theme-dark ps-active-y" data-ps-id="a5ce3685-88f1-e87b-2bc3-2aae13d05553">
      <div class="sidebar">
              ...
              <a href="#" class="media bg-blue-grey bg-lighten-5 border-right-primary border-right-2">
                ...
                <div class="media-body w-100">
                  <h6 class="list-group-item-heading">Wayne Burton
                    <span class="font-small-3 float-right primary">Today</span>
                  </h6>
    ...
    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 635px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 424px;"></div></div></div>
