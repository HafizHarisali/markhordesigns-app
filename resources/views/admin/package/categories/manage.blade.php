            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal form-bordered" method="get" action="{{route('package_categories_filter')}}">
                                <div class="form-body">
                                    <h4 class="form-section">Manage Package Categories</h4>
                                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{asset('public/assets/admin/images/packages/'.$row->featured_image)}}" height="70">
                                        </td>
                                        <td>{{$row->name}}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div role="group" class="btn-group">
                                                ...
                                                <div aria-labelledby="btnGroupDrop1" class="dropdown-menu">
                                                    <a href="{{route('package_categories_edit',$row->id)}}" class="dropdown-item">Edit</a>
                                                    <a href="{{route('package_categories_delete',$row->id)}}" data-toggle="modal" id="delete_category" data-target="#show" class="dropdown-item">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
