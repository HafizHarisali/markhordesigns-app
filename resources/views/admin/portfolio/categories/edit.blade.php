                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" action="{{route('portfolio_categories_update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row last">
                                                    ...
                                                    <div class="col-md-12">
                                                        <img class="single_image_preview_1" alt="Category Featured Image" src="{{asset('public/assets/admin/images/portfolio')}}/{{$data->featured_image}}" style="width:150px; height:150px"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
