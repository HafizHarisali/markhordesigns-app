            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal form-bordered" method="get" action="">
                                <div class="form-body">
                                    <h4 class="form-section">Manage Advertisement Banners</h4>
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{asset('public/assets/admin/images/advertisements/banners/'.$row->image)}}" height="70">
                                        </td>
                                        <td>
                                            <form method="post" id="formcheck" action="">
                                                @csrf
                                        ...
                                        <td>
                                            <div role="group" class="btn-group">
                                                ...
                                                <div aria-labelledby="btnGroupDrop1" class="dropdown-menu">
                                                    ...
                                                    <a href="" data-toggle="modal" id="delete_category" data-target="#show" class="dropdown-item">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
